...
To use and interact with this program, feel free to download the files and make sure they are in the same folder. Then, either double-click on the "Calculator.exe" file, or you can go to the command prompt in terminal, navigate to the appropriate directory, and run the .exe file by entering the following command: 

Calculator.exe

The program will then start, and then just follow the simple prompt directions.
.
.
.
.
