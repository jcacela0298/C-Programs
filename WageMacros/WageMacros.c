...
// to standard output (the screen) while using Macros and Typedef.
//
...
void printHeader (void) 
{ 
    // First, open a file called home10.txt, where the file pointer called outputfileptr will point to.
    if ((outputfileptr = fopen("home10.txt", "w")) == (FILE *) NULL)
    {
