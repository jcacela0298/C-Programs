...
The program will then start, and after following the simple prompt directions, the program will place the output into a new file by the name of "home8.txt". If a file with the same name already exists, it will be overwritten.
.
.
.
.
.
During this project, I learned more about pointers, prototypes with pointers, incrementation of arrays vs. structures, and overall C syntax.
