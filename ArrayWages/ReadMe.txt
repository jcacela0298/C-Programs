...
The program will then start, and after following the simple prompt directions, the OvertimeTracker program will place the output into a new file by the name of "home4.txt". If a file with the same name already exists, it will be overwritten.
.
.
.
.
